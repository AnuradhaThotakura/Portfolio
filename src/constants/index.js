...
export const HERO_CONTENT = `I build reliable backend systems and practical GenAI applications — from REST APIs and production fintech workflows to RAG-based tools that turn complex data into useful answers.`;
export const ABOUT_TEXT = `I'm a Python developer based in Hyderabad with a B.Tech in Computer Science from IIIT Nuzvid. Over the past 3+ years, I've grown from shipping fintech features at Moneybloom to building a multi-tenant Vendor Management System at TalentBridge. I enjoy working across the full backend lifecycle — API design, database modeling, integrations, Dockerized deployments, and background jobs — and I'm especially motivated by problems where clean engineering meets real user impact. Outside of work, I like exploring new tools, contributing to open source, and learning how emerging AI techniques can be applied responsibly in production.`;
